...
<body>
    <div class="container">
        <div class="row">
            ...
            <h3 class="text-center mt-3" style="color: white;">Istorija</h3>
                <?php
                $query = $mysqli->query("SELECT * FROM Istorija");
                while ($data = $query->fetch_object()) {
                    ...
                    echo '<h5 class="card-text">Datum događaja: ' . $data->DatumDogađaja . '</h5>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
